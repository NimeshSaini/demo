...
import static com.utkarshnew.android.DownloadServices.VideoDownloadService.CANCEL;
import static com.utkarshnew.android.DownloadServices.VideoDownloadService.CANCEL_ALL;
import static com.utkarshnew.android.DownloadServices.VideoDownloadService.DOWNLOAD_SERVICE_ID;
import static com.utkarshnew.android.DownloadServices.VideoDownloadService.PAUSE;
...
public abstract class CustomIntentService extends Service {
    ...
    public void onStart(@Nullable Intent intent, int startId) {
        ...
        if (intent != null && intent.getAction() != null) {
            ...
            if (intent != null)
                msg.what = intent.getIntExtra(DOWNLOAD_SERVICE_ID, -1);
    ...
    /*public static boolean isServiceRunning(int downloadServiceId){
        return isRunning();
    }

    public boolean isRunning(int downloadServiceId){
        return mServiceHandler.hasMessages(downloadServiceId);
    }*/
}
