 ...
 * Use the {@link LiveClasses#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LiveClasses extends Fragment implements NetworkCall.MyNetworkCallBack {

    private View view;
    private RecyclerView LiveClassesrecycler;
    ...
    public static LiveClasses newInstance(String param1, String param2) {
        LiveClasses fragment = new LiveClasses();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (livevideocompleted.size() == 0) {
            ...
            LiveClassesrecycler.setAdapter(liveclassadapter);
        }
    ...
    public void ErrorCallBack(String jsonstring, String apitype, String typeApi) {
        switch (apitype) {
            case API.get_liveclasses_data:
                ...
                if (LiveClassesrecycler != null && no_data_found_RL != null) {
                    LiveClassesrecycler.setVisibility(View.GONE);
                    no_data_found_RL.setVisibility(View.VISIBLE);
                }
                break;
